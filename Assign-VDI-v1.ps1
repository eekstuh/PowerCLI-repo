...
function Resolve-InteractiveActiveDirectoryUser {
    ...
    while ($true) {
        $resolvedAccount = Resolve-RequiredText -InitialValue $candidateAccount -WasSupplied $accountWasSupplied -Prompt "Enter user's SamAccountName or E-mail" -FieldName 'Active Directory account name'
        try {
