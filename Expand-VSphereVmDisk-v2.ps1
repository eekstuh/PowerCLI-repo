...
.EXAMPLE
.\Expand-VSphereVmDisk-v2.ps1 -VIServer vcsa01.contoso.com

.EXAMPLE
.\Expand-VSphereVmDisk-v2.ps1 -VIServer vcsa01.contoso.com -VMName APP01 -DiskNumber 2 -GBSizeToIncrease 100
